...
public class Controller {
	...
	@PostMapping("/add")
	public String addData(@SessionAttribute(name = "login", required = false) StudentPojo login, @RequestParam String name, @RequestParam String email, 
			@RequestParam long contact, @RequestParam String city,
	...
	@PostMapping("/search")
	public String searchData(@SessionAttribute(name = "login", required = false) StudentPojo login, @RequestParam int id,
			ModelMap map) {
		if (login == null) {
			map.addAttribute("msg", "Please login to proceed..!!");
			return "LoginForm";
	...
	@PostMapping("/update")
	public String updateForm(@SessionAttribute(name = "login", required = false) StudentPojo login, @RequestParam int id,
			ModelMap map) {
